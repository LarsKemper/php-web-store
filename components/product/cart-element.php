    ...
    <form method="POST" action="/php-web-store/api/post.php">
        ...
        <div class="w-full flex items-center">
            <button name="deleteFromCart" value="deleteFromCart" type="submit">
                <span class="group relative overflow-hidden rounded-lg w-16 h-16 bg-gray-50 border border-gray-200">
                    <span class="absolute cursor-pointer group-hover:block hidden z-50 h-full w-full bg-black bg-opacity-60">
