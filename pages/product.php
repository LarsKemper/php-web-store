                    ...
                    <div class="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            <form method="POST" action="/web-store/api/post.php">
                                ...
                                <h2 class="text-sm title-font text-gray-500 tracking-widest">web-store</h2>
                                ...
                                <div class="flex">
                                    <span
                                        class="title-font font-medium text-2xl text-gray-900"><?php echo $_SESSION["product"]["price"]; ?>€</span>
