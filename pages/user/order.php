        ...
        <?php if (isset($_SESSION["profile"]) && !empty($_SESSION["profile"]) && isset($_SESSION["order"]) && !empty($_SESSION["order"])) { ?>
            ...
            <div class="flex flex-col xl:flex-row jusitfy-center items-stretch w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
                <div class="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
                    <div class="flex flex-col justify-start items-start bg-white rounded-md px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full">
                        ...
                        if (isset($_SESSION["order"]["items"])) {
                            foreach ($_SESSION["order"]["items"] as $product) {
                                include_with_prop(__DIR__ . "/../../components/product/order-element.php", array("img_path" => $product["img_path"], "product_name" => $product["product_name"], "quantity" => $product["quantity"], "price" => $product["price"], "size" => $product["size"], "color" => $product["color"],));
                            }
                        } else {
                    ...
                    <div class="flex justify-center flex-col md:flex-row flex-col items-stretch w-full space-y-4 md:space-y-0 md:space-x-6 xl:space-x-8">
                        ...
                        <div class="flex flex-col justify-center px-4 py-6 md:p-6 xl:p-8 w-full bg-white rounded-md space-y-6">
                            <h3 class="text-xl font-semibold leading-5 text-gray-800">Shipping</h3>
                            <div class="flex justify-between items-start w-full">
                                <div class="flex justify-center items-center space-x-4">
                                    <div class="w-8 h-8">
                                        <img class="w-full h-full" alt="logo" src="./../../assets/images/dpd_logo.png"/>
                                    </div>
                ...
                <div class="bg-white rounded-md w-full xl:w-96 flex justify-between items-center md:items-start px-4 py-6 md:p-6 xl:p-8 flex-col">
                    ...
                    <div class="flex flex-col md:flex-row xl:flex-col justify-start items-stretch h-full w-full md:space-x-6 lg:space-x-8 xl:space-x-0">
                        <div class="flex flex-col justify-start items-start flex-shrink-0">
                            <div class="flex justify-center w-full md:justify-start items-center space-x-4 py-8 border-b border-gray-200">
                                <img class="h-12 w-12 rounded-md" src="./../../assets/images/user_pb.png" alt="avatar"/>
                                <div class="flex justify-start items-start flex-col space-y-2">
                                    <p class="text-base font-semibold leading-4 text-left text-gray-800">
                                        <?php echo $_SESSION["user"]["firstName"] . " " . $_SESSION["user"]["lastName"]; ?>
                                    </p>
                                    <p class="text-sm leading-5 text-gray-600">
                                        <?php echo $_SESSION["profile"]["country"]; ?>
                                    </p>
                                </div>
                            </div>
