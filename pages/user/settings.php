                    ...
                    <div class="flex-col py-5 px-5 bg-gray-100 rounded-md space-y-3">
                        ...
                        if(isset($_SESSION["orders"]) && !empty($_SESSION["orders"])){
                            foreach($_SESSION["orders"] as $order){   
                                include_with_prop(__DIR__."/../../components/product/list-element.php", array(
                                    "id" => $order["id"],
            ...
            <div class="mt-6 border-t border-gray-400 pt-4">
                <div class='flex flex-wrap -mx-3 mb-6'>
                    <div class='w-full md:w-full px-3 mb-6 '>
                        ...
                        <button
                            class="cursor-default bg-gray-300 px-3 p-2 rounded-md text-white text-base to-secondary-dark hover:to-secondary-default duration-300">
                            Change Password
                        </button>
                    </div>
                            ...
                            <div class='w-full md:w-full px-3 mb-6'>
                                ...
                                <div class="flex-shrink w-full inline-block relative">
                                    <select name="country"
                                        ...
                                        <option
                                            value="<?php echo isset($_SESSION["profile"]["country"]) ? $_SESSION["profile"]["country"] : "" ?>">
